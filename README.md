# This project is currently on pause due to ao3 not yet having a web API. Their roadmap says it's planned for 1.0, so when that happens, this project shall resume.
